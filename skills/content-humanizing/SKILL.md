...
This skill does two things simultaneously: reduces visible AI-writing patterns, and amplifies the author's distinctive voice.
Use it after editorial polishing, not before.

The goal is not just "less AI-sounding." It is "more unmistakably this author."
...
- fake neutrality
- bland conclusions
- voice absence: the writing is technically correct but sounds like no one in particular
...
### 4. Run a voice amplification pass

After reducing AI patterns, check for the opposite problem: is the author's perspective audible?

Ask:
- Is there at least one moment where the author's analytical frame is unmistakable — a judgment, a metaphor, or an observation that could only come from this specific writer?
- Are there places where the writing is "safe" when the brief or research supports a stronger stance?
- Does the conclusion land with the author's actual view, or does it hedge into neutrality?

Strengthen those moments without inventing new claims.

### 5. Run a preservation pass
...
- [ ] Voice amplification pass run: author's perspective is audible in at least 1-2 moments
- [ ] Facts preserved
- [ ] Structure preserved
